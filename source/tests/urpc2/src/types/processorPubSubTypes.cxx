...
public:
    ...
    typedef detail::Processor_Request type;
    ...
    // Destructor
    ~Processor_RequestPubSubType() override = default;
    ...
    {
        register_Processor_Request_type_identifier(type_identifiers_);
    }

};

class Processor_ReplyPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:
    // Alias for the type to be serialized.
    typedef detail::Processor_Reply type;
    ...
    // Destructor
    ~Processor_ReplyPubSubType() override = default;
    ...
    eProsima_user_DllExport void register_type_object_representation() override
    {
        register_Processor_Reply_type_identifier(type_identifiers_);
    }

};

eprosima::fastdds::dds::rpc::ServiceTypeSupport create_Processor_service_type_support()
{
    eprosima::fastdds::dds::TypeSupport request_type(
        new Processor_RequestPubSubType());
    eprosima::fastdds::dds::TypeSupport reply_type(
        new Processor_ReplyPubSubType());
